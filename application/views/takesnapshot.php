...
#camera {
  ...
  <body>
    ...
    <form method="" action="<?php  echo base_url(); ?>My_dashboard/imageDetection">
       <button id="submit-buttons" type="submit">Camera Exit</button>
    </form>
        ...
        <script>
                ...
                swf_url: "jpeg_camera/jpeg_camera.swf",
                  ...
                  $('#take_snapshots').click(function(){
                   ...
                   snapshot.upload({api_url: "webcamRequirements/action.php"}).done(function(response) {
